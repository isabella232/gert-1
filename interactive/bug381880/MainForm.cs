...
public class InstructionsForm : Form
{
	public InstructionsForm ()
	{
		...
		_bugDescriptionText1.Text = string.Format (CultureInfo.InvariantCulture,
			...
			"1. Click and hold the mouse button on groupbox A.{0}{0}" +
			"2. Move the mouse pointer over the textbox.{0}{0}" +
			"3. Move the mouse pointer to groupbox B.{0}{0}" +
			"Expected result:{0}{0}" +
			"1. The following events have fired:{0}{0}" +
			"   * GroupBoxA => DragEnter{0}" +
			"   * GroupBoxA => DragLeave{0}" +
			"   * GroupBoxB => DragEnter",
			Environment.NewLine);
		// 
		// _tabPage1
