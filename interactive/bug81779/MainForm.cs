...
public class InstructionsForm : Form
{
	public InstructionsForm ()
	{
		...
		_bugDescriptionText1.Text = string.Format (CultureInfo.InvariantCulture,
			...
			"2. Click the Child 4 node.{0}{0}" +
			"3. Expand the Child 5 node.{0}{0}" +
			"4. Double-click the Child 4 node.{0}{0}" +
			"Expected result:{0}{0}" +
			"1. No horizontal line is displayed.{0}{0}" +
			"2. Both the Child 4 and Child 5 node are expanded.{0}{0}" +
			"3. Only the node label of Child 4 is highlighted.",
			Environment.NewLine);
		// 
		// _tabPage1
		// 
		...
		_bugDescriptionText2.Text = string.Format (CultureInfo.InvariantCulture,
			...
			"Expected result:{0}{0}" +
			"1. No horizontal line is displayed.{0}{0}" +
			"3. Only the node label of Child 3 is highlighted.",
			Environment.NewLine);
		// 
		// _tabPage2
		// 
