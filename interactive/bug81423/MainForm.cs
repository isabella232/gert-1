...
public class InstructionsForm : Form
{
	public InstructionsForm ()
	{
		...
		_bugDescriptionText1.Text = string.Format (CultureInfo.InvariantCulture,
			...
			"1. All nodes in the TreeView are expanded.{0}{0}" +
#if NET_2_0
			"2. Node #0 is scrolled into view, selected and positioned at " +
			"at the top of the ListView.{0}{0}" +
			"3. The vertical scrollbar is positioned at the top of the " +
			"TreeView.{0}{0}" +
#else
			"2. Node #39 is scrolled into view, selected and positioned at " +
			"the top of the ListView.{0}{0}" +
			"3. The vertical scrollbar is positioned nearly at the bottom " +
			"of the TreeView.{0}{0}" +
#endif
			"4. The horizontal scrollbar is positioned left.{0}{0}" +
			"5. The TextBox is empty.",
			Environment.NewLine);
		// 
		// _tabPage1
		// 
