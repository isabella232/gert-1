...
public class InstructionsForm : Form
{
	public InstructionsForm ()
	{
		...
		_bugDescriptionText1.Text = string.Format (CultureInfo.InvariantCulture,
			...
			"4. Press the Esc key to cancel the LabelEdit.{0}{0}" +
			"5. Click the OK button.{0}{0}" +
			"Expected result:{0}{0}" +
			"1. On step 4:{0}{0}" +
			"   * The label can no longer be edited.{0}" +
			"   * The new node is highlighted.{0}" +
			"   * The TreeView has focus.{0}{0}" +
			"2. On step 5:{0}{0}" + 
		...
		_bugDescriptionText2.Text = string.Format (CultureInfo.InvariantCulture,
			...
			"2. Select the Desktop node.{0}{0}" +
			"3. Click the Make New Folder button.{0}{0}" +
			"4. Enter the name of an existing folder.{0}{0}" +
			"5. Press the Enter key.{0}{0}" +
			"6. Press the Esc key.{0}{0}" +
