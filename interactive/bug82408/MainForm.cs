...
public class InstructionsForm : Form
{
	public InstructionsForm ()
	{
		...
		_bugDescriptionText1.Text = string.Format (CultureInfo.InvariantCulture,
			...
			"Expected result:{0}{0}" +
			"1. The background color of the tooltip window is blue.{0}{0}" +
			"1. The color of the text in the tooltip window is white.",
			Environment.NewLine);
		// 
		// _tabPage1
		// 
