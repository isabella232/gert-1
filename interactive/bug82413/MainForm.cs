...
public class InstructionsForm : Form
{
	public InstructionsForm ()
	{
		...
		_bugDescriptionText1.Text = string.Format (CultureInfo.InvariantCulture,
			...
			"1. Left-click Node1 and hold the mouse button pressed.{0}{0}" +
			"2. Move the mouse over Node4.{0}{0}" +
			"3. Release the mouse button.{0}{0}" +
			"Expected result:{0}{0}" +
			"1. On step 2, the mouse cursor changes to a forbidden sign.{0}{0}" +
			"2. On step 3, Node1 has not been moved.{0}{0}" +
