...
internal class ReferencePathCollectionEditorForm : System.Windows.Forms.Form
{
	...
	public ReferencePathCollectionEditorForm ()
	{
		...
		imlcol.Add (new Bitmap (Image.FromFile ("folder.bmp")));
		imlcol.Add (new Bitmap (Image.FromFile ("folderpin.bmp")));
		imlcol.Add (new Bitmap (Image.FromFile ("multifolder.bmp")));
		imlcol.Add (new Bitmap (Image.FromFile ("multifolderpin.bmp")));
	}
