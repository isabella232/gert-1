...
public class InstructionsForm : Form
{
	public InstructionsForm ()
	{
		...
		_bugDescriptionText1.Text = string.Format (CultureInfo.InvariantCulture,
			...
			"2. Drop down the DateTimePicker and select a date.{0}{0}" +
			"3. Clear the value of the StartDate item.{0}{0}" +
			"4. Click on the Name item.{0}{0}" +
			"Expected result:{0}{0}" +
