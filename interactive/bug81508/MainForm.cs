...
public class InstructionsForm : Form
{
	public InstructionsForm ()
	{
		...
		_bugDescriptionText1.Text = string.Format (CultureInfo.InvariantCulture,
			...
			"1. Right-click on the form.{0}{0}" +
			"2. Move mouse pointer over the \"Insert date...\" menu item.{0}{0}" +
			"3. Click the dropdown arrow of the DateTimePicker.{0}{0}" +
			"4. Select another date.{0}{0}" +
			"Expected result:{0}{0}" +
			"1. The context menu remains displayed.{0}{0}" +
			"2. The newly selected date is displayed in the DateTimePicker " +
