...
public class MainForm
{
	...
	[DllImport ("user32.dll", CharSet = CharSet.Auto, CallingConvention = CallingConvention.StdCall)]
	internal extern static bool TranslateMessage (ref MSG msg);

	[DllImport ("user32.dll", CharSet = CharSet.Auto, CallingConvention = CallingConvention.StdCall)]
	internal extern static IntPtr DispatchMessage (ref MSG msg);

	[DllImport ("user32.dll", CharSet = CharSet.Auto, CallingConvention = CallingConvention.StdCall)]
	private extern static IntPtr ShowWindow (IntPtr hwnd, WindowPlacementFlags nCmdShow);

	[DllImport ("user32.dll", CharSet = CharSet.Auto, CallingConvention = CallingConvention.StdCall)]
	private extern static IntPtr UpdateWindow (IntPtr hWnd);
}
