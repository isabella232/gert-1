...
class TinyHost : MarshalByRefObject
{
	...
	static int Main ()
	{
		...
		if (!result.Contains ("ConfigurationErrorsException")) {
			Console.WriteLine (result);
			return 1;
		}
		if (!result.Contains ("The specified type 'Mono.Web.UI.TextBox' used for mapping must inherit from the original type 'System.Web.UI.WebControls.TextBox'.")) {
			Console.WriteLine (result);
			return 2;
		}
		return 0;
